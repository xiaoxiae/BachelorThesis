...
To make it further apparent which hold is currently held and which one is previous/next, the previous, current and next holds are displayed in the bottom of the screen.

\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{images/editor/picker.png}%
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth]{images/editor/settings.png}
...
\begin{figure}[h]
	\centering
	\subfloat{{\includegraphics[height=3cm]{images/markers/1.png} }}%
	\hfill
	\subfloat{{\includegraphics[height=3cm]{images/markers/2.png} }}%
	\hfill
	\subfloat{{\includegraphics[height=3cm]{images/markers/3.png} }}%
	\hfill
	\subfloat{{\includegraphics[height=3cm]{images/markers/4.png} }}%
...
\begin{figure}[h]
	\centering
	\subfloat{{\includegraphics[height=5cm]{images/editor/capture-1.png} }}%
	\hfill
	\subfloat{{\includegraphics[height=5cm]{images/editor/capture-2.png} }}%

...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{images/gauss/gauss-smol.png}
...
\begin{figure}
	\centering
	\subfloat{{\includegraphics[height=5cm]{images/sfm/side.png} }}%
...
\begin{figure}[t]
	\centering
	\subfloat{{\includegraphics[height=4.5cm]{images/dense/side.png} }}%
...
\begin{figure}
	\centering
	\subfloat[Textured view.]{{\includegraphics[height=2.3cm]{images/texture/texture.png} }}%
	\hfill
	\subfloat[Wireframe view.]{{\includegraphics[height=2.3cm]{images/texture/wireframe.png} }}%
...
\begin{figure}
	...
	\hfill
	\subfloat[\centering Motor gear.]{{\includegraphics[height=2.6cm]{images/turntable/gear-top.png} }}%
	\qquad
	\qquad
	\qquad
...
\begin{figure}
	% opravdu doufám, že tenhle kód nikdo číst nebude lmao
	\centering
	\subfloat[\centering Bottom part (top).]{{\includegraphics[height=5.4cm]{images/realturntable/base1.png} }}%
	\hfill
	\subfloat[\centering Bottom part (side).]{{\includegraphics[height=5.4cm]{images/realturntable/base2.png} }}%
	\\
	\subfloat[\centering Top part (bottom).]{{\includegraphics[height=6.2cm]{images/realturntable/top2.png} }}%
	\hfill
	\subfloat[\centering Top part (top).]{{\includegraphics[height=6.2cm]{images/realturntable/top1.png} }}%
	\caption{Parts of the model of the turntable, created using Fusion360.}%
	\label{fig:turntable}
\end{figure}
...
\begin{figure}
	% opravdu doufám, že tenhle kód nikdo číst nebude lmao
	\centering
	\subfloat[\centering Original.]{{\includegraphics[height=1.65cm]{images/masking/hold-clean.png} }}%
	\hfill
	\subfloat[\centering Smudges.]{{\includegraphics[height=1.65cm]{images/masking/hold.png} }}%
	\hfill
	\subfloat[\centering Hold contours.]{{\includegraphics[height=1.65cm]{images/masking/contourimage.jpg} }}%
	\hfill
	\subfloat[\centering Mask.]{{\includegraphics[height=1.65cm]{images/masking/mask.jpg} }}%
	\hfill
	\subfloat[\centering Result.]{{\includegraphics[height=1.65cm]{images/masking/resulting.jpg} }}%

...
\def\ThesisTitle{Climbing route scanner and editor}
...
\def\SupervisorsDepartment{KAM}

% Study programme and specialization
\def\StudyProgramme{\xxx{Obecná informatika}}
\def\StudyBranch{\xxx{Informatika}}

\def\Dedication{%
I'm grateful for the support from my friends and family, namely Kateřina Sulková, Jan Černý, Benjamin Schiller and Jakub Pelc.
...
Byl vyvinut způsob tvorby 3D modelů chytů a stěn a doprovázející 3D editor, aby cesty z reálného světa mohly být přeneseny do toho virtuálního k interaktivnímu prohlížení.
}
